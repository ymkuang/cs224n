...
public class NER {
	...
	if (args.length < 2) {
	    System.out.println("USAGE: java -Xmx4g -Xprof -cp \"classes:extlib/*\" cs224n.deep.NER ../data/train ../data/dev [windowSize=5] [hiddenlayerSize=100] [maxIteration=20] [learningRate=0.01] [regularization=0.0001] [randomvector=0]");
	    return;
	}	    
	...
	if (args.length >=8)
		randomVector = (Integer.parseInt(args[7]));
    ...
    */
    ...
    // One layer NN
	// initialize model 
	WindowModel model = new WindowModel(windowSize, hiddenSize, maxIter, learningRate, regularization, randomVector);
	System.out.println("Current super-parameters used: Window size: " + windowSize + ", Hidden layer size: " + hiddenSize + ", Max Iteration: " + maxIter + ", Learning Rate: " + learningRate + " and regularization: " + regularization + " randomVector ?= " + randomVector);
	model.initWeights();
